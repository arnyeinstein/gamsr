l.all <- list()
i <- gdxrrw::rgdx.set('trnsport.gdx', 'i', compress = TRUE, ts = TRUE, te = TRUE )
...
j <- gdxrrw::rgdx.set('trnsport.gdx', 'j', compress = TRUE, ts = TRUE, te = TRUE )
...
a <- tibble::as_data_frame(gdxrrw::rgdx.param('trnsport.gdx', 'a', compress = TRUE, ts = TRUE, squeeze = FALSE))%>% map_if(is.factor, as.character) %>% as_data_frame ->a
...
b <- tibble::as_data_frame(gdxrrw::rgdx.param('trnsport.gdx', 'b', compress = TRUE, ts = TRUE, squeeze = FALSE))%>% map_if(is.factor, as.character) %>% as_data_frame ->b
...
d <- tibble::as_data_frame(gdxrrw::rgdx.param('trnsport.gdx', 'd', compress = TRUE, ts = TRUE, squeeze = FALSE))%>% map_if(is.factor, as.character) %>% as_data_frame ->d
...
f <- gdxrrw::rgdx.scalar('trnsport.gdx', 'f', ts = TRUE)
...
c <- tibble::as_data_frame(gdxrrw::rgdx.param('trnsport.gdx', 'c', compress = TRUE, ts = TRUE, squeeze = FALSE))%>% map_if(is.factor, as.character) %>% as_data_frame ->c
...
x <- tibble::as_data_frame(rgdx.var(x)) 
 x%>% map_if(is.factor, as.character) %>% as_data_frame ->x
...
z <- tibble::as_data_frame(rgdx.var(z)) 
 z%>% map_if(is.factor, as.character) %>% as_data_frame ->z
