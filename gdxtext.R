l.all <- list()
i <- gdxrrw::rgdx.set('./trnsport.gdx', 'i' )
...
j <- gdxrrw::rgdx.set('./trnsport.gdx', 'j' )
...
a <- gdxrrw::rgdx.param('./trnsport.gdx', 'a', squeeze = FALSE)
...
b <- gdxrrw::rgdx.param('./trnsport.gdx', 'b', squeeze = FALSE)
...
d <- gdxrrw::rgdx.param('./trnsport.gdx', 'd', squeeze = FALSE)
...
c <- gdxrrw::rgdx.param('./trnsport.gdx', 'c', squeeze = FALSE)
...
x <- tibble::as_data_frame(rgdx_var(x))
...
z <- tibble::as_data_frame(rgdx_var(z))
