l.all <- list()
Merged_set_1 <- gdxrrw::rgdx.set('./merged.gdx', 'Merged_set_1', compress = TRUE )
...
results_gdp <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_gdp', compress = TRUE, squeeze = FALSE))
...
results_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_r', compress = TRUE, squeeze = FALSE))
...
results_r_reg <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_r_reg', compress = TRUE, squeeze = FALSE))
...
results_r_h <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_r_h', compress = TRUE, squeeze = FALSE))
...
results_a_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_a_r', compress = TRUE, squeeze = FALSE))
...
results_f_a_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_f_a_r', compress = TRUE, squeeze = FALSE))
...
results_f_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_f_r', compress = TRUE, squeeze = FALSE))
...
results_a_c_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_a_c_r', compress = TRUE, squeeze = FALSE))
...
results_c_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_c_r', compress = TRUE, squeeze = FALSE))
 attributes(results_c_r)$type <- 'parameter'
 l.all[[10]] <- list(name ='results_c_r', data = results_c_r, description = 'Warning: no description', type = 'parameter')
 names(l.all)[10] ='results_c_r'
 names(results_c_r) <- gsub(x = names(results_c_r), pattern = '*', replacement = 'index', fixed=TRUE)
results_ins_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_ins_r', compress = TRUE, squeeze = FALSE))
 attributes(results_ins_r)$type <- 'parameter'
 l.all[[11]] <- list(name ='results_ins_r', data = results_ins_r, description = 'Warning: no description', type = 'parameter')
 names(l.all)[11] ='results_ins_r'
 names(results_ins_r) <- gsub(x = names(results_ins_r), pattern = '*', replacement = 'index', fixed=TRUE)
results_ins_f_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_ins_f_r', compress = TRUE, squeeze = FALSE))
 attributes(results_ins_f_r)$type <- 'parameter'
 l.all[[12]] <- list(name ='results_ins_f_r', data = results_ins_f_r, description = 'Warning: no description', type = 'parameter')
 names(l.all)[12] ='results_ins_f_r'
 names(results_ins_f_r) <- gsub(x = names(results_ins_f_r), pattern = '*', replacement = 'index', fixed=TRUE)
results_c_h_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_c_h_r', compress = TRUE, squeeze = FALSE))
 attributes(results_c_h_r)$type <- 'parameter'
 l.all[[13]] <- list(name ='results_c_h_r', data = results_c_h_r, description = 'Warning: no description', type = 'parameter')
 names(l.all)[13] ='results_c_h_r'
 names(results_c_h_r) <- gsub(x = names(results_c_h_r), pattern = '*', replacement = 'index', fixed=TRUE)
results_c_r_reg <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_c_r_reg', compress = TRUE, squeeze = FALSE))
 attributes(results_c_r_reg)$type <- 'parameter'
 l.all[[14]] <- list(name ='results_c_r_reg', data = results_c_r_reg, description = 'Warning: no description', type = 'parameter')
 names(l.all)[14] ='results_c_r_reg'
 names(results_c_r_reg) <- gsub(x = names(results_c_r_reg), pattern = '*', replacement = 'index', fixed=TRUE)
results_ins_insp_r <- tibble::as_data_frame(gdxrrw::rgdx.param('./merged.gdx', 'results_ins_insp_r', compress = TRUE, squeeze = FALSE))
 attributes(results_ins_insp_r)$type <- 'parameter'
 l.all[[15]] <- list(name ='results_ins_insp_r', data = results_ins_insp_r, description = 'Warning: no description', type = 'parameter')
 names(l.all)[15] ='results_ins_insp_r'
